...
DEFAULT_MODEL_PATH = "hustvl/MaTVLM_0_25_Mamba2"
...
def get_response(params):
    ...
    if max_new_tokens < 1:
        ...
        return
    if "mamba" in args.model_path.lower():
...
def build_demo(model_path):
    ...
    with gr.Blocks(title="MaTVLM", theme=gr.themes.Default(), css=block_css) as demo:
        state = gr.State()

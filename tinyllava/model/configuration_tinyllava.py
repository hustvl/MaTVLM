...
class TinyLlavaConfig(PretrainedConfig):
    ...
    def __init__(
        ...
        hybrid_model_name_or_path = None,
        ...
        **kwargs
        ...
        self.hybrid_model_name_or_path = hybrid_model_name_or_path
    ...
    def load_from_config(self, config):
        ...
        self.hybrid_model_name_or_path = getattr(config, 'hybrid_model_name_or_path',  None)

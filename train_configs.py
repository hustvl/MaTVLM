...
class DistillConfig(transformers.TrainingArguments):
    ...
    sl_weight: float = field(
        default=0,
        metadata={"help": "Ratio of SL loss."},
    )
    tl_weight: float = field(
        default=0,
        metadata={"help": "Ratio of TL loss."},
    )
    tl_loss_type: str = field(
        default="kl",
        metadata={"help": "Type of TL loss."},
    )
    bid_mode: bool = field(
        default=False,
        metadata={"help": "Whether to use bidirectional mode."},
    )
    tune_mlp: bool = field(
        default=False,
        metadata={"help": "Whether to tune the MLP."},
    )
    output_hidden_states: bool = field(
        default=False,
        metadata={"help": "Whether to output hidden states."},
    )
    ...
    is_bias: bool = field(default=False)
    stable_steps: int = field(default=0)
    decay_steps: int = field(default=0)
# @dataclass
